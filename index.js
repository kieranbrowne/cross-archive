...
var author$project$Main$metDecoder = A2(elm$json$Json$Decode$field, 'x', elm$json$Json$Decode$string);
...
var author$project$Main$getMetObject = function (id) {
	return elm$http$Http$get(
		{
			expect: A2(elm$http$Http$expectJson, author$project$Main$GotText, author$project$Main$metDecoder),
			url: A2(
				elm$core$String$join,
				'',
				_List_fromArray(
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		author$project$Main$getMetObject('1234567'));
};
